...
$id= mysqli_real_escape_string($saha,$_POST['keyword']);
...
<h1><img src="logo.png" width="128" height="128" alt="EWS"> 
  Easy Web Search - Admin Panel</h1>
            ...
            <div class="clients-list">
                              ...
                              <fieldset>
                              <legend><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>" class="btn btn-primary">Go Back</a> New Keyword</legend>
                                 <div class="form-group">
                                   
                                   
                                   <label style="clear:both;">Keyword </label>
                                 
                                   <input name="keyword" type="text" required="required" class="form-control input-lg" id="keyword" placeholder="Keyword"  value=""  />
