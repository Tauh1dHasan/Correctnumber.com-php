...
$query_selected = "SELECT * FROM settings";
...
mysqli_select_db($saha, $database_saha);
$query_total = "SELECT * FROM crawl WHERE (crawl.title LIKE '%$cid%' OR crawl.description LIKE '%$cid%'  OR crawl.current_url LIKE '%$cid%'  OR crawl.keywords LIKE '%$cid%'  OR crawl.content LIKE '%$cid%' OR crawl.actual_url LIKE '%$cid%')";
...
mysqli_select_db($saha, $database_saha);
$query_selected = "SELECT * FROM crawl WHERE (crawl.title LIKE '%$cid%' OR crawl.description LIKE '%$cid%'  OR crawl.current_url LIKE '%$cid%'  OR crawl.keywords LIKE '%$cid%'  OR crawl.content LIKE '%$cid%' OR crawl.actual_url LIKE '%$cid%') LIMIT $stt,$lim";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
...
mysqli_select_db($saha, $database_saha);
$query_selected = "SELECT * FROM crawl ORDER BY crawl.id DESC LIMIT $stt,$lim";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
...
<table class="table table-striped table-hover table-bordered">
                                 ...
                                 <div class="input-group">
                                    <input type="text" placeholder="Search Data" name="q" class="form-control input-lg" value="<?php echo htmlentities(stripslashes(@$cid)); ?>">
...
mysqli_select_db($saha, $database_saha);
$query_selectedCrawl = "SELECT * FROM crawl_images WHERE crawl_images.actual_url= '$CURL'";
...
URL : <a href="<?php echo $row_selected['current_url']; ?>" target="_blank" class="client-link" data-toggle="tab"><?php echo substr($row_selected['current_url'],0,20);if(strlen($row_selected['current_url'])>20){echo "...".substr($row_selected['current_url'],-10);} ?></a>
