...
mysqli_select_db($saha, $database_saha);
$query_total = "SELECT * FROM crawl_images WHERE (crawl_images.image_url LIKE '%$cid%' OR crawl_images.current_url LIKE '%$cid%'  OR crawl_images.keywords LIKE '%$cid%'  OR crawl_images.actual_url LIKE '%$cid%')";
...
mysqli_select_db($saha, $database_saha);
$query_selected = "SELECT * FROM crawl_images WHERE (crawl_images.image_url LIKE '%$cid%' OR crawl_images.current_url LIKE '%$cid%'  OR crawl_images.keywords LIKE '%$cid%' OR crawl_images.actual_url LIKE '%$cid%') LIMIT $stt,$lim";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
...
mysqli_select_db($saha, $database_saha);
$query_total = "SELECT * FROM crawl_images";
$total = mysqli_query($saha, $query_total) or die(mysqli_error($saha));
$row_total = mysqli_fetch_assoc($total);
$totalRows_total = mysqli_num_rows($total);
...
mysqli_select_db($saha, $database_saha);
$query_selected = "SELECT * FROM crawl_images ORDER BY crawl_images.id DESC LIMIT $stt,$lim";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
