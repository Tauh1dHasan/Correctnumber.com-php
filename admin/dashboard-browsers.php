...
$query_selectedURL = "SELECT * FROM url_views GROUP BY url_views.browser";
...
$i=0;
 do{
$i++;	
$BROWSER=$row_selectedURL['browser'];

mysqli_select_db($saha, $database_saha);
$query_selectedURL1 = "SELECT * FROM url_views WHERE url_views.browser='$BROWSER'";
...
$i++;	 
?>
                "<?php echo $row_selectedURL['browser']; ?>"<?php if($i!=$totalRows_selectedURL){?>,<?php }?>
<?php } while ($row_selectedURL = mysqli_fetch_assoc($selectedURL));?>
            ]
        },
        options: {
