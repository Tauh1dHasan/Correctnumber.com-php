...
$query_selected = "SELECT * FROM crawl WHERE crawl.id='$id'";
...
mysqli_select_db($saha, $database_saha);
$query_selectedCrawl = "SELECT * FROM crawl_images WHERE crawl_images.current_url= '$CURL' AND crawl_images.deleted='N'  AND crawl_images.block_update='N'";
