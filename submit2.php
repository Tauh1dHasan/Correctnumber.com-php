...
<div class="container">
    <div class="row row-centered">
        ...
        <div class="content">
        <div>
        <form  method="post" action="submit2_fun.php">
        ...
        <fieldset>
			...
			<div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" placeholder="http://www.domain.com" name="web_url" id="q" class="form-control" value="<?php echo urldecode(@$_GET["url"]); ?>" pattern="https?://.+" autofocus>
                </div>
             </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="title" class="form-control" name="title" placeholder="Dummy text" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="contact_person" class="form-control" name="contact_person" placeholder="Dummy text" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="company_name" class="form-control" name="company_name" placeholder="Dummy text" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="email" id="email" class="form-control" name="email" placeholder="user@mail.com" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="mobile_number" class="form-control" name="mobile_number" placeholder="xxx xxx xxxxx" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="phone_number" class="form-control" name="phone_number" placeholder="xxx xxx xxxxx" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="land_mark" class="form-control" name="land_mark" placeholder="Dummy text" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="city" class="form-control" name="city" placeholder="Dummy text" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="state" class="form-control" name="state" placeholder="Dummy text" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="country" class="form-control" name="country" placeholder="Dummy text" required>
                            </div>
                        </div>
                   <!-- edited by tauhid -->
                        <div class="form-group row">
                        ...
                        <!-- edited by tauhid -->
                        <div class="form-group row">
                            <label for="keywords" class="col-md-3 col-form-label text-md-right">Please let us know who are your target Clients</label>
                            <div class="col-md-9">
                                <textarea type="text" id="keywords" class="form-control" name="targeted_client" required ></textarea>
                            </div>
                        </div>
                        
                        <!-- edited by tauhid -->
                        <div class="form-group row">
                            <label for="keywords" class="col-md-3 col-form-label text-md-right">Short note you want to tell us</label>
                            <div class="col-md-9">
                                <textarea type="text" id="keywords" class="form-control" name="short_note" required ></textarea>
                            </div>
                        </div>
                            
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input name="sesubmit" type="checkbox" class="form-control" id="sesubmit" value="Y" required><br>
...
Agree to pay Rs.600 INR Or 10 USD Per Month As Admin Charges
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input type="checkbox" id="agree" class="form-control" name="commission" required ><br>
Agree to pay 5% commission on every sell
