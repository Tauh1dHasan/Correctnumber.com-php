...
<?php do{ ?>                           
<?php $i++;?>   
      <div class="col-lg-3 col-sm-4 col-xs-6"><a title="<?php echo $row_searchResults['base_url'] ?>" href="#"><img class="thumbnail img-responsive" src="piccrop.php?w=400&img=<?php echo base64_encode($row_searchResults['image_url']); ?>"></a></div>
