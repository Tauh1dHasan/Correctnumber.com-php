...
mysqli_select_db($saha, $database_saha);
$query_total = "SELECT * FROM keywords WHERE (keywords.keyword LIKE '%$cid%')";
...
mysqli_select_db($saha, $database_saha);
$query_selected = "SELECT * FROM keywords WHERE (keywords.keyword LIKE '%$cid%') LIMIT $stt,$lim";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
...
mysqli_select_db($saha, $database_saha);
$query_total = "SELECT * FROM keywords";
$total = mysqli_query($saha, $query_total) or die(mysqli_error($saha));
$row_total = mysqli_fetch_assoc($total);
$totalRows_total = mysqli_num_rows($total);
...
mysqli_select_db($saha, $database_saha);
$query_selected = "SELECT * FROM keywords ORDER BY keywords.id DESC LIMIT $stt,$lim";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
                                 ...
                                 <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                       ...
                                       Search
                                            ...
                                            <td class="client-status" colspan="3"><a href="keywords-new.php" class="btn btn-success btn-lg">New Keyword</a></td>
                                          </tr>
                                          <tr>
                                            <td>Keyword</td>
...
<?php do { ?>
                                                ...
                                                <tr>
                                                  <td><strong><?php echo stripslashes($row_selected['keyword']); ?></strong> 
                                                    
</td>
                                                   <td class="client-status"><a href="keywords-update.php?id=<?php echo $row_selected['id']; ?>" class="btn btn-primary">Update</a></td>
                                                   <td class="client-status"> 

<a href="keywords-delete.php?id=<?php echo $row_selected['id']; ?>&deleted=Y"  class="btn btn-danger">Delete</a>
</td>
                                                </tr>
