...
<div class="container">
    <div class="row row-centered">
        ...
        <div class="input-group">
                                    <input autocomplete="off" name="q" type="text" required class="form-control input-lg" id="q" placeholder="Search Web" value="<?php echo strip_tags(htmlentities(stripslashes(@$cid))); ?>">
